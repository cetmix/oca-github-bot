...
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/cetmix/cetmix-maintainer-tools@7f6de8cf26662e506ffe2c532ad385e5979d0f3c#egg=oca-maintainers-tools \
