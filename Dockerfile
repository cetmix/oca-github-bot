...
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/cetmix/cetmix-maintainer-tools@368f7e9536481387aed6797e321a3f5e5ac080c7#egg=oca-maintainers-tools \
