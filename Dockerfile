...
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/cetmix/cetmix-maintainer-tools@ea2a2c00296161c9482a0c42d0c841271ce83e70#egg=oca-maintainers-tools \
