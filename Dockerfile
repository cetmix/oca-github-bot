...
RUN set -x \
  && /ocamt/bin/pip install --no-cache-dir -e git+https://github.com/cetmix/cetmix-maintainer-tools@149761a3726aaa4fca2143be5edbc34e8e615c09#egg=oca-maintainers-tools \
